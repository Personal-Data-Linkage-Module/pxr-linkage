...
TARGET='./ext/{ext_name}/actor/pxr-root/流通制御サービスプロバイダー_item.json'
echo ${TARGET}
...
sed -i 's/<organization_statement_sentence>/流通制御サービスプロバイダーです。/g' ${TARGET}

# /ext/{ext_name}/block/pxr-root/PXR-Root-Block_item.json
TARGET='./ext/{ext_name}/block/pxr-root/PXR-Root-Block_item.json'
echo ${TARGET}
...
TARGET='./ext/{ext_name}/setting/actor-own/pxr-root/actor_{pxr_root_actor_code}/setting_item.json'
echo ${TARGET}
...
TARGET='./ext/{ext_name}/setting/global/setting_item.json'
echo ${TARGET}
...
TARGET='./ext/{ext_name}/terms-of-use/platform/pf-terms-of-use_item.json'
echo ${TARGET}
